...
mod_codeWASVisualization_ui <- function(id) {
  ns <- shiny::NS(id)
  ...
  header <-
    shinydashboard::dashboardHeader(title = "codeWAS", headerContent)
...
mod_codeWASVisualization_server <- function(id, connectionHandler, resultDatabaseSettings) {
  ...
  shiny::moduleServer(id, function(input, output, session) {
    ...
    mod_codeWASPlot_server("codeWAS", connectionHandler)
